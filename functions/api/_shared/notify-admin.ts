    ...
    <div style="font-family:Arial,'Microsoft YaHei',sans-serif;line-height:1.7;color:#111827;">
      ...
      <table style="border-collapse:collapse;width:100%;max-width:720px;">
        ${rows.map(([label, value]) => `
          <tr>
            <td style="border:1px solid #e5e7eb;padding:8px;background:#f9fafb;width:120px;">${escapeHtml(label)}</td>
...
export async function notifyAdminNewPriceRequest(env: NotifyEnv, payload: PriceRequestPayload) {
